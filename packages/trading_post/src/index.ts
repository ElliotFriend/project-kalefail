...
export type Storage = {tag: "Owner", values: void} | {tag: "KaleAddress", values: void} | {tag: "Vegetables", values: void} | {tag: "MaxVegetables", values: void} | {tag: "IsOpen", values: void};
...
export interface Client {
   ...
   */
  trade: ({customer, vegetable, amount, buy_kale}: {customer: string, vegetable: string, amount: i128, buy_kale: boolean}, options?: {
    /**
   ...
   */
  add_vegetables: ({vegetables_to_add}: {vegetables_to_add: Array<string>}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  remove_vegetables: ({vegetables_to_remove}: {vegetables_to_remove: Array<string>}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * bother then?
   */
  grow_shelf_space: ({new_max_vegetables}: {new_max_vegetables: u32}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * maximum.
   */
  shrink_shelf_space: ({new_max_vegetables}: {new_max_vegetables: u32}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  static async deploy<T = Client>(
        ...
        {owner, kale, vegetables, max_vegetables}: {owner: string, kale: string, vegetables: Option<Array<string>>, max_vegetables: Option<u32>},
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
