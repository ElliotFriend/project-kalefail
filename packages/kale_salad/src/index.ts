...
export const networks = {
  testnet: {
    ...
    contractId: "CBMIAPVP3CLX7OHSIYL4WHG6IN323DLEU6ENVQXT6XKY7ZUNHPGZ6BLI",
  }
} as const
...
export type Storage = {tag: "Admin", values: void} | {tag: "Metadata", values: void} | {tag: "Vegetables", values: void} | {tag: "PaymentPerToken", values: void} | {tag: "Supply", values: void} | {tag: "MintIndex", values: void} | {tag: "Balance", values: readonly [string]} | {tag: "Owner", values: readonly [u32]} | {tag: "Approved", values: readonly [u32]} | {tag: "ApprovedAll", values: readonly [string]};
...
export interface Client {
   ...
   * - data - `token_id: u32`
   */
  mint_salad: ({owner, payment_each_vegetable, number_of_tokens}: {owner: string, payment_each_vegetable: i128, number_of_tokens: Option<u32>}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  token_by_index: ({index}: {index: u32}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  token_of_owner_by_index: ({owner, index}: {owner: string, index: u32}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
        ...
        "",
