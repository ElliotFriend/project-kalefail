...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CBMIAPVP3CLX7OHSIYL4WHG6IN323DLEU6ENVQXT6XKY7ZUNHPGZ6BLI";
    };
};
...
export interface Client {
     ...
     * - data - `token_id: u32`
     */
    mint_salad: ({ owner, payment_each_vegetable, number_of_tokens }: {
        owner: string;
     ...
     */
    burn_from: ({ spender, owner, token_id }: {
        spender: string;
        owner: string;
        token_id: u32;
    }, options?: {
     ...
     */
    approve_all: ({ owner, spender, expiration_ledger }: {
        owner: string;
        spender: string;
        expiration_ledger: u32;
    }, options?: {
     ...
     */
    transfer_from: ({ spender, owner, to, token_id }: {
        spender: string;
        owner: string;
        to: string;
        token_id: u32;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        token_by_index: (json: string) => AssembledTransaction<number>;
        token_of_owner_by_index: (json: string) => AssembledTransaction<number>;
