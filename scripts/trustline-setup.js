...
import { Asset, Keypair, TransactionBuilder, Operation, Networks, BASE_FEE, rpc, TimeoutInfinite } from '@stellar/stellar-sdk';
...
let trustlineTx = new TransactionBuilder(
    distSource, {
        fee: BASE_FEE,
...
VEGETABLES.forEach((v) => {
    trustlineTx.addOperation(Operation.changeTrust({
        asset: v,
    }))
})
